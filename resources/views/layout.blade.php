...
<head>
    ...
    <link type="text/css" href="{{asset('/frontend/css/font-awesome.min.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('/frontend/css/prettyPhoto.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('/frontend/css/price-range.css')}}" rel="stylesheet">
    ...
    <link type="text/css" href="{{asset('/frontend/css/responsive.css')}}" rel="stylesheet">
    <!--[if lt IE 9]>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                @yield('content') // vị trí phần tử con cần phải ghi đè
            </div>
        </div>
    </div>
</section>
